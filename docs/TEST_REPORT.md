...
| Node and frontend procedures | `pnpm test` | **15 passed**. Covers auth logout; scan-result, artifact, and delete-confirmation validation; local upload validation; corrupt-upload server-response mapping; unavailable-model response mapping; and English/Hindi route-copy safeguards. |
