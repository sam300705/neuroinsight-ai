...
function Router() { return <AppShell><Suspense fallback={<RouteLoading />}><Switch><Route path="/" component={Home} /><Route path="/analyse" component={Analyse} /><Route path="/results" component={Results} /><Route path="/history" component={History} /><Route path="/methodology" component={Methodology} /><Route path="/performance" component={Performance} /><Route path="/limitations" component={Limitations} /><Route path="/responsible-use" component={ResponsibleUse} /><Route path="/verify" component={VerifyPassport} /><Route path="/about" component={About} /><Route component={NotFound} /></Switch></Suspense></AppShell>; }
