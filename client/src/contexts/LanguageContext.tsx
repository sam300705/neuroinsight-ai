...
const copy = {
  en: { navigation: "Navigation", analyze: "Analyse scan", results: "Results", history: "Scan history", methodology: "Methodology", performance: "Model performance", evidence: "Evidence ledger", limitations: "Limitations", responsible: "Responsible use", verify: "Verify passport", about: "About project", academic: "Academic and research use only — not a medical diagnosis.", language: "हिंदी", home: "Overview", skip: "Skip to main content", toggleNavigation: "Toggle navigation", switchLanguage: "Switch language to Hindi" },
  hi: { navigation: "नेविगेशन", analyze: "स्कैन विश्लेषण", results: "परिणाम", history: "स्कैन इतिहास", methodology: "कार्यप्रणाली", performance: "मॉडल प्रदर्शन", evidence: "एविडेंस लेजर", limitations: "सीमाएँ", responsible: "जिम्मेदार उपयोग", verify: "पासपोर्ट सत्यापित करें", about: "परियोजना के बारे में", academic: "केवल शैक्षणिक और शोध उपयोग के लिए — यह चिकित्सीय निदान नहीं है।", language: "English", home: "अवलोकन", skip: "मुख्य सामग्री पर जाएँ", toggleNavigation: "नेविगेशन बदलें", switchLanguage: "भाषा को अंग्रेज़ी में बदलें" },
} as const;
